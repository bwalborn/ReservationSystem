...
class ReservationsTest < ApplicationSystemTestCase
  ...
  test "creating a Reservation" do
    ...
    fill_in "Phonenumber", with: @reservation.PhoneNumber
    fill_in "Resname", with: @reservation.ResName
    fill_in "Seatcount", with: @reservation.SeatCount
    fill_in "Tablecount", with: @reservation.TableCount
